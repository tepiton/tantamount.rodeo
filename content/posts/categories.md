...
date: 2019-01-20
excerpt: When I was figuring out how collections work, I tried my hand at implementing a collection of collections. I called the things in the collection of collections categories.
category: Tech
tags:
  - eleventy
  - static-sites
...
I want there to be Categories in Eleventy to organize articles into broad domains.^[That's what I say _now_. The original impetus for this was to figure out [how collections work](/articles/collections/).]

The idea is that all articles about books will go into the Culture category, articles about tech go into the Tech category, and so on.
...
We can use the `makeCategories()` function as a callback to `addCollection()` to create this object. We iterate over each item that has a `category` property in its front matter and add it to the list for that category:[^explanation]
